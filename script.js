document.addEventListener('DOMContentLoaded', function() {
    ...
    const encouragements = [
        "Cố lên neee! 💪",
        "Đừng bỏ cuộc, anh biết em làm được màaa! 😊",
        "Nghỉ ngơi để làm việc hiệu quả nheee! 🌸",
        "Em bé ăn gì, anh mua đem qua choaaa! ✨",
        "Anh biết em đang cố gắng rất nhiều. Đừng quên dành thời gian cho chính mình nữa nhé!😊",
        "Cứ thảnh thơi, đừng áp lực nhiều quá nhéee! 🌟",
        "Cứ từ từ, không ai ép em cả. Có anh ở đây mà! 😌",
        "Bất kể chuyện gì xảy ra, em vẫn là người đặc biệt với anh!💕",
        "Anh sẽ luôn đồng hành cùng em! 💕",
        "Anh ở đây, không để giải quyết mọi thứ thay em — mà để cùng em vượt qua!💖",
        "Có việc gì cần thì hú anh nhooo! ⚡",
        "Nếu em cần 1 cái ôm, có anh đâyyy! 💫",
        "Anh đang nhớ em! 💖",
    ];
    ...
    function updateBatteryLevel() {
        ...
        if (chargeLevel >= 100) {
            encouragementBox.innerHTML = "<em>Sạc đầy pin roi neee! 🌟</em>";
            createConfetti();
            createFireworks();
    ...
    function showNextCard() {
        ...
        nextCard.innerHTML = `
            <h1>Nhớ dành thời gian nghỉ ngơi nhéee!</h1>
            <div class="gif-container">
                <img src="images/recharge.gif" alt="Recharging animation" class="recharge-gif">
            </div>
            <div class="reminder-message">
                <p><em>Công việc quan trọng và em cũng vậy! Quay lại đây để sạc năng lượng lúc em cảm thấy mệt mỏi nhéee</em></p>
            </div>
            <button id="restart-btn">Sạc pin⚡</button>
        `;
